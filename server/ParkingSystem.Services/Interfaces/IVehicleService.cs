...
namespace ParkingSystem.Services.Interfaces
{
    public interface IVehicleService
    {
        ...
        List<VehicleInfoResource> GetFilteredVehicles(string registrationNumber, int[] selectedCatecories, int?[] selectedDiscounts, DateTime[] dateRange, int? sorting, int? sortingOrder, int page, int itemsPerPage);
    }
}
