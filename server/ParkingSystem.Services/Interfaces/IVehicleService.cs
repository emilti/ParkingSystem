...
namespace ParkingSystem.Services.Interfaces
{
    public interface IVehicleService
    {
        ...
        List<VehicleInfoResource> GetFilteredVehicles(string registrationNumber, int[] selectedCatecories, int?[] selectedDiscounts, int? sorting, int? sortingOrder, int page, int itemsPerPage);
    }
}
