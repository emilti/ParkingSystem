...
namespace ParkingSystem.Data.Migrations
{
    ...
    [Migration("20210322155253_VehicleToUserRequierementUpdated")]
    partial class VehicleToUserRequierementUpdated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParkingSystem.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ParkingSystem.Data.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ParkingSystem.Data.Models.Vehicle", b =>
                {
                    ...
                    b.HasOne("ParkingSystem.Data.Models.ApplicationUser", "Driver")
                        .WithMany()
